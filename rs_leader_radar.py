...
# Event / M&A filters
# -----------------------------
MAX_20D_RETURN = 0.35            # 최근 20일 +35% 초과 제외
MAX_SINGLE_DAY_SPIKE = 0.18      # 단일 일봉 +18% 초과 제외
MIN_10D_RANGE = 0.018            # 최근 10일 범위 1.8% 미만 제외 (가격 고정형 제거)
MAX_15D_RETURN = 0.35            # 최근 15일 +35% 초과 제거
MAX_GAP_DAY = 0.15               # 갭성 점프 제거 보조
